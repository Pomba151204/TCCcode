 ...
 * @author Flavio_Mania
 */
public class LerRFIDFXMLController implements Initializable {
            ...
            new Thread(() -> {
                ...
                while (true) {
                    try {
                        ...
                        Platform.runLater(() -> {
                            //mostra o valor da TEG no text
                            disp.setText(data.trim());
                            if(data.trim().equals("31 CD A3 1B")){
                                shpCorValor.setFill(Color.BLUE);
                            }else if(data.trim().equals("51 27 A0 1B")){
                                shpCorValor.setFill(Color.CORAL);
                            }
                            else{
                                shpCorValor.setFill(Color.TRANSPARENT);
                            }
                        });
                        ...
                        Logger.getLogger(lerrfid.LerRFIDFXMLController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }).start();
